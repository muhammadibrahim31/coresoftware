...
int CaloValid::End(PHCompositeNode* topNode)
{
  ...
  //------OHCal-----//
  {
	...
	auto h_CaloValid_ohcal_etaphi_ZSpedRMS = dynamic_cast<TProfile2D*>(hm->getHisto(boost::str(boost::format("%sohcal_etaphi_ZSpedRMS") % getHistoPrefix()).c_str()));
...
void CaloValid::createHistos()
{
  ...
  // Create 3D histograms for the eta-phi distribution with trigger indices as the z-axis
